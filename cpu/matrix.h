...
template <typename T> class Matrix {
    ...
    public:
        ...
        // Function to fill the matrix using the Xavier initialization, 
        void xavier() {

            // The Xavier initialization is computed as follows:
            // We initialize the weights of the neural network by drawing them from a normal distribution
            // with a mean of 0 and a standard deviation of sqrt(2 / (fan_in + fan_out)), where fan_in is the 
            // number of input units and fan_out is the number of output units.
            int fan_in = this->rows;
            int fan_out = this->cols;
    ...
    private:
        ...
        // Function to generate a random generator using the normal distribution
